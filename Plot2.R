...
# Create Plot 2 as described in Course Project
...
plot(finalData$Date_Time, finalData$Global_active_power, xaxt=NULL, xlab = "", ylab = "Global Active Power (kilowatts)", type="n")
